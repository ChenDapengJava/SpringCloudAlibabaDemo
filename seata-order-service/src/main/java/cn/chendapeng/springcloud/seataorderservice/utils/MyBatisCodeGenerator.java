package cn.chendapeng.springcloud.seataorderservice.utils;
...
public class MyBatisCodeGenerator {
    ...
    private static final String JDBC_URL = "jdbc:mysql://192.168.242.112:3306/seata-order?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
     ...
     * 包名和模块名
     */
    private static final String PACKAGE_NAME = "cn.chendapeng.springcloud.seataorderservice";
    private static final String MODULE_NAME = "order";

    /**
     * 表名，多个表使用英文逗号分割
     */
    private static final String TBL_NAMES = "t_order";
    ...
    private static GlobalConfig getGlobalConfig() {
        ...
        String projectPath = System.getProperty("user.dir") + "/seata-order-service";
